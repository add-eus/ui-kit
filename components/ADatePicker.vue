...
<template>
  <div class="a-date-picker">
    <VueDatePicker v-model="date" :auto-apply="!hasValidation" :format="format" :placeholder="dateTranslate"
      :cancelText="cancelTranslate" :selectText="validateTranslate" :day-names="dayNames" time-picker-inline
      :enable-time-picker="hasTime" :range="type === 'range'"
      :class="{ 'type-range': type === 'range', multi: type === 'range' }" :multi-calendars="type === 'range'"
      :action-row="{
