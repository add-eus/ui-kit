...
The `ATabs` component allows you to create a set of tabs with customizable styling.

## Usage

The `ATabs` component offers the following options:
...
- `selected` (string, optional): The value of the currently selected tab.
